...
namespace Synapse.IntegrationTests.Localization;
...
///       <c>Synapse.UI.Features.Common.Services.SettingLocalizationService</c>), so a missing key
...
public class LocalizationKeyReferenceTests
{
    ...
    private static readonly string EnJsonPath = Path.Combine(
        TestContext.SolutionDir, "src", "Synapse.UI", "Features", "Common", "Localization", "en.json");
