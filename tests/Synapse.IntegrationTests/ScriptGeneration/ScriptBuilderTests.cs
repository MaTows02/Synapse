...
namespace Synapse.IntegrationTests.ScriptGeneration;
...
public class ScriptBuilderTests
{
    ...
    public ScriptBuilderTests()
    {
        ...
        _powerSettingsQuery
            ...
            .ReturnsAsync(new Synapse.Core.Features.Optimize.Models.PowerPlan
            {
                Name = "Balanced",
    ...
    public async Task Build_WithWindowsApps_ContainsAppRemoval()
    {
        ...
        // Act
        var script = await _builder.BuildmentsScriptAsync(config, allSettings);
