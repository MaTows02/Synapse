...
public class ConfigRoundTripTests
{
    ...
    [Theory]
    [InlineData("Synapse_Default_Config_Windows10_22H2.synapse")]
    [InlineData("Synapse_Default_Config_Windows11_25H2.synapse")]
    [InlineData("Synapse_Recommended_Config.synapse")]
    public void EmbeddedConfigFile_DeserializesWithoutErrors(string fileName)
    {
        ...
        var configDir = Path.Combine(
            ...
            "src", "Synapse.UI", "Features", "Common", "Resources", "Configs");
