...
///
/// The . config wire format serializes Selection state as a
...
/// pre-migration . config file and proves that every Selection entry in it
...
{
    // Test project build output lives at tests/Synapse.UI.Tests/bin/x64/Debug/net10.0-windows10.0.19041.0/ .
    // From AppContext.BaseDirectory that's 4 ".." hops up to tests/Synapse.UI.Tests/ , then into Fixtures/.
    private static readonly string FixturePath = Path.Combine(
        AppContext.BaseDirectory, "..", "..", "..", "..", "Fixtures", "pre-migration-sample.synapse");
    ...
    /// <summary>
    /// Walks a . JSON document and records every Selection-type entry
    ...
    /// tests agree on what "a Selection entry in a . config" looks like.
    /// </summary>
