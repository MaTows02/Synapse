...
public class SettingLocalizationServiceTests
{
    ...
    public void LocalizeSetting_LocalizesComboBoxDisplayNames()
    {
        ...
        var setting = CreateTestSetting(comboBox: new ComboBoxMetadata
        {
            Options = new[]
            {
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option A" },
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option B" }
            }
        });
    ...
    public void LocalizeSetting_ComboBoxNames_WhenLocalizationKeyUsed_UsesKeyDirectly()
    {
        ...
        var setting = CreateTestSetting(comboBox: new ComboBoxMetadata
        {
            Options = new[]
            {
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Template_MyOption" }
            }
        });
    ...
    public void LocalizeSetting_LocalizesOptionWarnings()
    {
        ...
        var setting = CreateTestSetting(comboBox: new ComboBoxMetadata
        {
            ...
            {
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option A" },
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option B", Warning = "Original Warning" }
            }
        });
    ...
    public void LocalizeSetting_LocalizesOptionTooltips()
    {
        ...
        var setting = CreateTestSetting(comboBox: new ComboBoxMetadata
        {
            Options = new[]
            {
                new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option A", Tooltip = "Original Tooltip" }
            }
        });
