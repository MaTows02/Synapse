...
using Synapse.Core.Features.Customize.Models;
...
public class SettingItemViewModelTests : IDisposable
{
    ...
    public void UpdateStatusBanner_WithOptionWarning_SetsErrorBanner()
    {
        ...
        var settingDef = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption
                    {
    ...
    public void UpdateStateFromSystemState_Selection_SeparateACDC_UpdatesBothIndices()
    {
        var settingDef = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option A", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 10 } } },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option B", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 20 } } },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option C", ValueMappings = new Dictionary<string, object?> { { "PowerCfgValue", 30 } } }
                }
            },
            PowerCfgSettings = new List<PowerCfgSetting>
            {
    ...
    {
        var list = new List<Synapse.Core.Features.Common.Models.ComboBoxOption>();
        foreach (var (name, v, rec, def) in options)
        {
            list.Add(new Synapse.Core.Features.Common.Models.ComboBoxOption
            {
                DisplayName = name,
