...
public class MainWindowViewModelTests : IDisposable
{
    ...
    public void Constructor_InitializesDefaultProperties()
    {
        ...
        sut.AppIconSource.Should().Be("ms-appx:///Assets/AppIcons/Synapse-rocket-white-transparent-bg.png");
        sut.VersionInfo.Should().Be("");
    ...
    public void Initialize_SubscribesToThemeChangedEvent()
    {
        ...
        _mockThemeService.Raise(t => t.ThemeChanged += null, this, Theme.LightNative);

        sut.AppIconSource.Should().Be("ms-appx:///Assets/AppIcons/Synapse-rocket-black-transparent-bg.png");
    }
    ...
    public void Initialize_SetsVersionInfo()
    {
        ...
        sut.VersionInfo.Should().Be(" v25.05.01");
    }
    ...
    {
        var sut = CreateSut();
        sut.AppSubtitle.Should().Be("by MaTows");
    }
