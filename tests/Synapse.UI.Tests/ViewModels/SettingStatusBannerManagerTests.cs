        ...
        var definition = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    ...
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Option B", Warning = "Security risk!" }
                }
            }
        };
        ...
        var definition = new SettingDefinition
        {
            ...
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    ...
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Custom" }
                }
            }
        };
