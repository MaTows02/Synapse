...
public class WimStep1ViewModelTests
{
    ...
    [Fact]
    public void Constructor_InitializesWorkingDirectoryToTempWIM()
    {
        _sut.WorkingDirectory.Should().Be("C:\\Temp\\WIM");
    }
    ...
    public async Task SelectWorkingDirectoryCommand_WhenNotExtractedAlready_CreatesSubDirectory()
    {
        ...
        _mockFileSystemService.Verify(f => f.CreateDirectory("D:\\WorkDir\\WIM"), Times.Once);
        _sut.WorkingDirectory.Should().Be("D:\\WorkDir\\WIM");
    }
    ...
    public async Task StartIsoExtractionCommand_OnSuccess_SetsIsExtractionComplete()
    {
        ...
        _mockTaskProgressService
            ...
            .Returns(new Progress<Synapse.Core.Features.Common.Models.TaskProgressDetail>());

        _mockIsoService
            .Setup(i => i.ExtractIsoAsync(
                It.IsAny<string>(), It.IsAny<string>(),
                It.IsAny<IProgress<Synapse.Core.Features.Common.Models.TaskProgressDetail>>(),
