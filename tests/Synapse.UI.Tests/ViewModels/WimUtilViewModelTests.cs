...
public class WimUtilViewModelTests : IDisposable
{
    ...
    {
        // Step1 sets WorkingDirectory in its constructor to TempPath\WIM.
    ...
    [Fact]
    public void GenerateXmlCommand_ForwardsToStep2()
    {
        _sut.GenerateXmlCommand.Should().BeSameAs(_sut.Step2.GenerateXmlCommand);
    }
