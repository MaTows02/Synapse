...
using Moq;
using Synapse.Core.Features.AdvancedTools.Interfaces;
using Synapse.Core.Features.Common.Interfaces;
using Synapse.Core.Features.Common.Models;
using Synapse.UI.Features.AdvancedTools.ViewModels;
...
public class WimStep2XmlViewModelTests : IDisposable
{
    ...
    {
        _sut.GenerateXmlCard.Should().NotBeNull();
    ...
    {
        _sut.GenerateXmlCard.IsEnabled.Should().BeTrue();
    ...
    [Fact]
    public async Task GenerateXmlCommand_WhenWorkingDirectoryEmpty_ShowsWarningAndReturns()
    {
        // WorkingDirectory defaults to empty
        await _sut.GenerateXmlCommand.ExecuteAsync(null);
    ...
    [Fact]
    public async Task GenerateXmlCommand_WhenUserCancels_DoesNotGenerate()
    {
    ...
    [Fact]
    public async Task GenerateXmlCommand_OnSuccess_SetsIsXmlAdded()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _mockDialogService
            .Setup(d => d.ShowConfirmationAsync(It.IsAny<ConfirmationRequest>()))
        ...
        _sut.GenerateXmlCard.IsComplete.Should().BeTrue();
    }

    [Fact]
    public async Task GenerateXmlCommand_OnSuccess_ClearsOtherCardCompletions()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
    ...
    [Fact]
    public async Task GenerateXmlCommand_OnException_SetsHasFailed()
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _mockDialogService
            .Setup(d => d.ShowConfirmationAsync(It.IsAny<ConfirmationRequest>()))
        ...
        _sut.GenerateXmlCard.HasFailed.Should().BeTrue();
    }
    ...
    {
        _sut.WorkingDirectory = "C:\\WorkDir";
        _sut.GenerateXmlCard.IsComplete = true;
        _sut.SelectXmlCard.IsComplete = true;
        ...
        _sut.GenerateXmlCard.IsComplete.Should().BeFalse();
        _sut.SelectXmlCard.IsComplete.Should().BeFalse();
        _sut.DownloadXmlCard.IsComplete.Should().BeTrue();
    }
