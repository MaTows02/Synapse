...
using Synapse.UI.Features.Settings.ViewModels;
using Xunit;
...
public class SettingsViewModelTests
{
    ...
    public void Constructor_LoadsCurrentTheme()
    {
        _mockThemeService
            .Setup(t => t.CurrentTheme)
            .Returns(Theme.DarkNative);

        var vm = CreateViewModel();

        vm.SelectedTheme.Should().Be(Theme.DarkNative);
    }
    ...
    public void Constructor_InitializesThemesCollection_WithThreeOptions()
    {
        ...
        vm.Themes.Select(t => t.Theme).Should().Contain(Theme.System);
        vm.Themes.Select(t => t.Theme).Should().Contain(Theme.LightNative);
        vm.Themes.Select(t => t.Theme).Should().Contain(Theme.DarkNative);
    }
    ...
    public void Constructor_SetsSelectedThemeOption_MatchingCurrentTheme()
    {
        _mockThemeService
            .Setup(t => t.CurrentTheme)
            .Returns(Theme.LightNative);

        var vm = CreateViewModel();

        vm.SelectedThemeOption.Should().NotBeNull();
        vm.SelectedThemeOption!.Theme.Should().Be(Theme.LightNative);
    }
    ...
    public void SelectedTheme_SetToNewValue_CallsThemeServiceSetTheme()
    {
        ...
        vm.SelectedTheme = Theme.DarkNative;

        _mockThemeService.Verify(t => t.SetTheme(Theme.DarkNative), Times.Once);
    }
    ...
    public void SelectedTheme_SetToSameAsCurrentTheme_DoesNotCallSetTheme()
    {
        ...
        vm.SelectedTheme = Theme.System;

        _mockThemeService.Verify(t => t.SetTheme(It.IsAny<Theme>()), Times.Never);
    }
    ...
    {
        var vm = CreateViewModel();
        var darkOption = vm.Themes.First(t => t.Theme == Theme.DarkNative);
    ...
    public void OnLanguageChanged_UpdatesThemeDisplayNames()
    {
        ...
        var systemTheme = vm.Themes.First(t => t.Theme == Theme.System);
        systemTheme.DisplayText.Should().Be("Systeme");

        var lightTheme = vm.Themes.First(t => t.Theme == Theme.LightNative);
        lightTheme.DisplayText.Should().Be("Clair");

        var darkTheme = vm.Themes.First(t => t.Theme == Theme.DarkNative);
