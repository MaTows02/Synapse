...
public class ComboBoxResolverTests
{
    ...
    private static IReadOnlyList<Synapse.Core.Features.Common.Models.ComboBoxOption> BuildOptions(
        string[] displayNames,
        Dictionary<int, Dictionary<string, object?>>? mappings)
    {
        var options = new List<Synapse.Core.Features.Common.Models.ComboBoxOption>(displayNames.Length);
    ...
    private static IReadOnlyList<Synapse.Core.Features.Common.Models.ComboBoxOption> BuildOptionsFromMappings(
        Dictionary<int, Dictionary<string, object?>> mappings)
    {
