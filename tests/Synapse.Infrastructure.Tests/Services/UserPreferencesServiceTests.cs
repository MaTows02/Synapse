...
public class UserPreferencesServiceTests
{
    ...
    private const string ConfigDir = @"C:\Users\TestUser\AppData\Local\\Config";
    private const string PrefsFilePath = @"C:\Users\TestUser\AppData\Local\\Config\UserPreferences.json";
