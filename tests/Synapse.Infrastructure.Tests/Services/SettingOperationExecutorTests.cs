    ...
    public async Task ApplySettingOperationsAsync_ScriptMappings_DisabledIndex_RunsDisabledScript()
    {
        var setting = CreateSetting("ps-scriptmap", InputType.Selection) with
        {
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Off", Script = ScriptOption.Disabled },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "On", Script = ScriptOption.Enabled },
                },
            },
            PowerShellScripts = new[]
            {
    ...
    public async Task ApplySettingOperationsAsync_ScriptMappings_EnabledIndex_RunsEnabledScript()
    {
        var setting = CreateSetting("ps-scriptmap-en", InputType.Selection) with
        {
            ComboBox = new ComboBoxMetadata
            {
                ...
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Off", Script = ScriptOption.Disabled },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Manual", Script = ScriptOption.Enabled },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Auto", Script = ScriptOption.Enabled },
                },
            },
            PowerShellScripts = new[]
            {
    ...
    public async Task ApplySettingOperationsAsync_NoScriptMappings_Selection_FallsBackToEnableFlag()
    {
        var setting = CreateSetting("ps-no-scriptmap", InputType.Selection) with
        {
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Off" },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "On" },
                },
            },
            PowerShellScripts = new[]
            {
    ...
    public async Task ApplySettingOperationsAsync_ScriptMappings_NoneIndex_SkipsPowerShellRunner()
    {
        var setting = CreateSetting("ps-scriptmap-none", InputType.Selection) with
        {
            ComboBox = new ComboBoxMetadata
            {
                Options = new[]
                {
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Show all", Script = ScriptOption.Enabled },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Hide all", Script = ScriptOption.Disabled },
                    new Synapse.Core.Features.Common.Models.ComboBoxOption { DisplayName = "Custom", Script = ScriptOption.None },
                },
            },
            PowerShellScripts = new[]
            {
