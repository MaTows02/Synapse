...
public class VersionServiceTests
{
    ...
    public void BuildInstallerArgs_AlwaysIncludesDirArgPinnedToAppDir(string appDir, bool isPortable)
    {
        ...
        // (regular) or ~\Desktop\ (portable) regardless of where the
    ...
    {
        // Act
        var args = VersionService.BuildInstallerArgs(@"D:\Portable\", isPortable: true);
    ...
    {
        // Act
        var args = VersionService.BuildInstallerArgs(@"C:\Program Files\", isPortable: false);
