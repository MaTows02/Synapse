...
using Xunit;
using static Synapse.Infrastructure.Features.SoftwareApps.Services.WinGet.Utilities.WinGetProgressParser;

namespace Synapse.Infrastructure.Tests.Utilities;
