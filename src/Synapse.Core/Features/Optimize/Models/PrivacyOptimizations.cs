...
namespace Synapse.Core.Features.Optimize.Models;
            ...
            Settings = new List<SettingDefinition>
            {
                ...
                new SettingDefinition
                {
                    ...
                    RegistrySettings = new List<RegistrySetting>
                    {
                        new RegistrySetting
                        {
                            KeyPath = @"HKEY_CURRENT_USER\Software\\Settings",
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Displays rotating Windows Spotlight images on your lock screen instead of a static background.  automatically sets the Start Menu Recommended Section to Show when this setting is enabled as it is required",
                    GroupName = "Lock Screen",
                    IconPack = "Fluent",
                    Icon = "ImageCircle",
                    InputType = InputType.Toggle,
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Displays promotional content, tips, and feature suggestions within the Windows Settings app.  automatically sets the Start Menu Recommended Section to Show when this setting is enabled as it is required",
                    GroupName = "General",
                    Icon = "StarCog",
                    InputType = InputType.Toggle,
                    Dependencies = new List<SettingDependency>
