...
<#
  ...
  .NOTES
      Source: https://github.com/memstechtips/
...
# Setup logging
$logFolder = ""C:\ProgramData\Synapse\Logs""
...
function Install-EdgeProtocolRedirect {
    ...
    $scriptsDir = ""C:\ProgramData\\OpenWebSearch""
...
""@
    ...
    Register-ScheduledTask -TaskName $repairTaskName -TaskPath ""\\"" -Action $repairAction -Trigger $repairTrigger -Settings $repairSettings -Principal $repairPrincipal -Force | Out-Null
...
$stubPath = ""C:\ProgramData\\OpenWebSearch\ie_to_edge_stub.exe""
