...
namespace Synapse.Core.Features.Customize.Models;
        ...
        return new SettingGroup
        {
            ...
            Settings = new List<SettingDefinition>
            {
                ...
                new SettingDefinition
                {
                    ...
                    Description = "Controls the transparency level of the taskbar.  automatically enables Transparency Effects when this setting is applied",
                    GroupName = "Taskbar Behavior",
                    InputType = InputType.Selection,
                    Icon = "Opacity",
                    IsWindows10Only = true,
