...
public class UserPreferencesService : IUserPreferencesService
{
    ...
    private string GetPreferencesFilePath()
    {
        try
        {
            ...
            string appDataPath = _fileSystemService.CombinePath(localAppData, "Synapse", "Config");
        ...
        catch (Exception ex)
        {
            ...
            string tempPath = _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), "Synapse", "Config");
