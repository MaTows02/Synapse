...
{
    private const string LiveUrl = "https://raw.githubusercontent.com/Matows/Synapse/main/sponsors/sponsors.json";
    private const string UserAgent = "Synapse-Sponsors-Loader";
    ...
    public string GetLogoUri(SponsorEntry sponsor)
    {
        ...
        return $"https://raw.githubusercontent.com/Matows/Synapse/main/sponsors/{logo}";
    }
