        ...
        CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            if (string.IsNullOrEmpty(driverSourcePath))
            {
                ...
                var tempDriverPath = _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), $"Drivers_{Guid.NewGuid()}");
