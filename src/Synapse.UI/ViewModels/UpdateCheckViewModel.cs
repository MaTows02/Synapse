...
namespace Synapse.UI.ViewModels;
...
public partial class UpdateCheckViewModel : ObservableObject, IDisposable
{
    ...
    private async Task CheckForUpdatesAsync()
    {
        ...
        try
        {
            ...
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, "Checking for updates...");
            ...
            {
                _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, $"Update available: {latestVersion.Version}");
            ...
            {
                _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, "No updates available");
        ...
        {
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Error, $"Error checking for updates: {ex.Message}");
    ...
    private async Task InstallUpdateAsync()
    {
        ...
        {
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Error, $"Error installing update: {ex.Message}");
    ...
    private void Relaunch()
    {
        ...
        {
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Error, $"Error relaunching: {ex.Message}");
        }
    }
    ...
    public async Task CheckForUpdatesOnStartupAsync()
    {
        try
        {
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, "Startup: Checking for updates...");
            ...
            if (latestVersion != null && latestVersion.IsUpdateAvailable)
            {
                _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, $"Startup: Update available: {latestVersion.Version}");
            ...
            {
                _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Info, "Startup: No updates available");
            }
        }
        catch (Exception ex)
        {
            _logService.Log(Synapse.Core.Features.Common.Enums.LogLevel.Error, $"Startup: Error checking for updates: {ex.Message}");
        }
    }
    ...
    private void RefreshUpdateInfoBarText()
    {
        switch (_updateInfoBarState)
        {
            case UpdateInfoBarState.UpdateAvailable:
                var message = _localizationService.GetString("Dialog_Update_Message") ?? "Good News! A New Version of  is available.";
            ...
            case UpdateInfoBarState.NoUpdates:
                ...
                UpdateInfoBarMessage = _localizationService.GetString("Dialog_Update_NoUpdates_Message") ?? "You have the latest version of .";
                break;
            ...
            case UpdateInfoBarState.UpdateDownloaded:
                ...
                UpdateInfoBarMessage = _localizationService.GetString("Dialog_Update_Installed_Message") ?? "The update has been downloaded. Click Relaunch to install and restart .";
                break;
        }
    }
}
