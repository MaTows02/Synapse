...
using Synapse.UI.Features.Common.Extensions.DI;
...
public partial class App : Application
{
    ...
    protected override void OnLaunched(Microsoft.UI.Xaml.LaunchActivatedEventArgs args)
    {
        ...
        try
        {
            ...
            _host = CompositionRoot.CreateHost().Build();
            ...
            try
            {
                ...
                // Start file logging to C:\ProgramData\Synapse\Logs
                try
                {
                    ...
                    if (_logService is Synapse.Core.Features.Common.Services.LogService concreteLogService)
                    {
    ...
    private void InitializeLocalization()
    {
        try
        {
            ...
            // Synapse by MaTows is French-first. Users can still select any
            // bundled language from Settings and that choice remains persisted.
            var savedLanguage = preferencesService.GetPreference("Language", "fr");
