...
public sealed partial class MainWindow : Window, INotifyPropertyChanged
{
    ...
    private void NavSidebar_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        _navigationRouter?.NavigateToPage(ContentFrame, "Dashboard", applyNavBadges: ApplyNavBadges);
        StartupLogger.Log("MainWindow", "Dashboard selected");
    }
    ...
    private void ModeButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        Mode? target = tag switch
        {
            "Normal" => Mode.Normal,
            "Builder" => Mode.Builder,
            "ConfigReview" => Mode.ConfigReview,
            _ => null
        };
    ...
    private void NavigateAccelerator_Invoked(KeyboardAccelerator sender, KeyboardAcceleratorInvokedEventArgs args)
    {
        var tag = sender.Key switch
        {
            ...
            VirtualKey.Number2 => "SoftwareApps",
            VirtualKey.Number3 => "Optimize",
            VirtualKey.Number4 => "Customize",
            VirtualKey.Number5 => "AdvancedTools",
            VirtualKey.Number6 => "Settings",
            _ => null
        };
