...
public partial class WimUtilViewModel : ObservableObject, IDisposable
{
    ...
    public Synapse.Core.Features.AdvancedTools.Models.ImageFormatInfo? CurrentImageFormat => ImageFormat.CurrentImageFormat;
    ...
    public Synapse.Core.Features.AdvancedTools.Models.ImageDetectionResult? DetectionResult => ImageFormat.DetectionResult;
    ...
    public WizardActionCard GenerateXmlCard => Step2.GenerateXmlCard;
    ...
    public IAsyncRelayCommand GenerateXmlCommand => Step2.GenerateXmlCommand;
