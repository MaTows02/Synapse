...
using Synapse.Core.Features.Common.Exceptions;
...
public partial class WimStep1ViewModel : ObservableObject
{
        ...
        IResourceService resourceService)
    {
        ...
        WorkingDirectory = _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), "WIM");
    ...
    private void CreateActionCards()
    {
        ...
        SelectDirectoryCard = new WizardActionCard
        {
            ...
            Description = string.Format(
                ...
                _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), "WIM")),
    ...
    private async Task SelectWorkingDirectory()
    {
        ...
        {
            WorkingDirectory = _fileSystemService.CombinePath(selectedPath, "WIM");
            try
            {
    ...
    internal async Task<bool> ValidateExtractedIsoDirectory(string path)
    {
        try
        {
            ...
            var testFile = _fileSystemService.CombinePath(path, $"._write_test_{Guid.NewGuid()}.tmp");
            try
            {
    ...
    partial void OnHasExtractedIsoAlreadyChanged(bool value)
    {
        SelectDirectoryCard.Description = value
            ...
            : string.Format(_localizationService.GetString("WIMUtil_Card_SelectDirectory_Description_Default"), _fileSystemService.CombinePath(_fileSystemService.GetTempPath(), "WIM"));
    }
}
