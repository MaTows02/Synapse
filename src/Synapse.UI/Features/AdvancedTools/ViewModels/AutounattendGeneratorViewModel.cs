...
public partial class AutounattendGeneratorViewModel : ObservableObject
{
    ...
    public string GenerateCardDescription => _localizationService.GetString("AdvancedTools_GenerateCard_Description") ?? "Generate an autounattend.xml file based on your current  selections to customize Windows during installation.";
