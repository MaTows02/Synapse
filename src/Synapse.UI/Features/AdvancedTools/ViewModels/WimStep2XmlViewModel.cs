...
using Synapse.UI.Features.AdvancedTools.Models;
using Synapse.UI.Features.Common.Interfaces;

namespace Synapse.UI.Features.AdvancedTools.ViewModels;
...
public partial class WimStep2XmlViewModel : ObservableObject, IDisposable
{
    ...
    public WizardActionCard GenerateXmlCard { get; private set; } = new();
    ...
    {
        GenerateXmlCard = new WizardActionCard
        {
            Icon = "\uE710",
            Title = _localizationService.GetString("WIMUtil_Card_GenerateXML_Title"),
            Description = _localizationService.GetString("WIMUtil_Card_GenerateXML_Description"),
            ButtonText = _localizationService.GetString("WIMUtil_Card_GenerateXML_Button"),
            ButtonCommand = GenerateXmlCommand,
            IsEnabled = true
        };
    ...
    private async Task GenerateXml()
    {
        try
        {
            GenerateXmlCard.IsComplete = false;
            GenerateXmlCard.HasFailed = false;
            ...
            {
                Message = _localizationService.GetString("WIMUtil_Card_GenerateXML_Description"),
                Title = _localizationService.GetString("WIMUtil_Card_GenerateXML_Title"),
            ...
            GenerateXmlCard.IsComplete = true;
        }
        catch (Exception ex)
        {
            ...
            GenerateXmlCard.HasFailed = true;
    ...
    {
        if (exceptCard != "generate") GenerateXmlCard.IsComplete = false;
