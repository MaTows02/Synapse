...
public partial class AdvancedToolsViewModel : ObservableObject, IDisposable
{
    ...
    /// </summary>
    public string AutounattendXmlDescription => _localizationService.GetString("AdvancedTools_GenerateCard_Description") ?? "Generate an autounattend.xml file based on your current  selections to customize Windows during installation.";
