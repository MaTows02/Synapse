...
namespace Synapse.UI.Features.AdvancedTools;
...
public sealed partial class WimUtilPage : Page
{
    ...
    public WimUtilPage()
    {
        ...
        ActualThemeChanged += (_, _) => UpdateXmlCardIcon();
        UpdateXmlCardIcon();
    ...
    private void UpdateXmlCardIcon()
    {
        ...
        XmlCardIcon.Source = new BitmapImage(new Uri(uri));
    }
    ...
    private void SubscribeToActionCards()
    {
        ...
        WizardActionCard?[] cards =
        {
            ...
            ViewModel.GenerateXmlCard, ViewModel.DownloadXmlCard, ViewModel.SelectXmlCard,
