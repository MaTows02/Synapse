...
using Synapse.Core.Features.Common.Events.UI;
...
using IConfigReviewService = Synapse.Core.Features.Common.Interfaces.IConfigReviewService;
using ILocalizationService = Synapse.Core.Features.Common.Interfaces.ILocalizationService;
using IUserPreferencesService = Synapse.Core.Features.Common.Interfaces.IUserPreferencesService;
using IBulkSettingsActionService = Synapse.Core.Features.Common.Interfaces.IBulkSettingsActionService;
using Synapse.UI.Features.Common.Models;
using Synapse.UI.Features.Customize.Pages;
using Synapse.UI.Features.Customize.ViewModels;

namespace Synapse.UI.Features.Customize;
...
public sealed partial class CustomizePage : Page
{
    ...
    private async void ApplyRecommended_Click(object sender, RoutedEventArgs e)
    {
        ...
        else if (_applicationModeService?.CurrentMode == Mode.Builder)
    ...
    private List<Synapse.UI.Features.Optimize.ViewModels.SettingItemViewModel> GetCurrentPageSettingViewModels()
    {
        var settings = new List<Synapse.UI.Features.Optimize.ViewModels.SettingItemViewModel>();
