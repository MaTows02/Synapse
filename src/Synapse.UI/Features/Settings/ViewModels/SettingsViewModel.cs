...
using Synapse.Core.Features.Common.Extensions;
...
namespace Synapse.UI.Features.Settings.ViewModels;
...
public partial class SettingsViewModel : ObservableObject, IDisposable
{
    ...
    {
        Themes.Clear();
        Themes.Add(new ThemeOption(Theme.System, GetThemeDisplayName(Theme.System)));
        Themes.Add(new ThemeOption(Theme.LightNative, GetThemeDisplayName(Theme.LightNative)));
        Themes.Add(new ThemeOption(Theme.DarkNative, GetThemeDisplayName(Theme.DarkNative)));
    }

    /// <summary>
    /// Gets the localized display name for a theme.
    /// </summary>
    private string GetThemeDisplayName(Theme theme) => theme switch
    {
        Theme.System => _localizationService.GetString("Theme_System") ?? "System",
        Theme.LightNative => _localizationService.GetString("Theme_LightNative") ?? "Light",
        Theme.DarkNative => _localizationService.GetString("Theme_DarkNative") ?? "Dark",
        _ => theme.ToString()
    };
    ...
    public string PageDescription => _localizationService.GetString("Settings_Description") ?? "Configure  Application Preferences";
    ...
    /// </summary>
    private void OnSelectedThemeChanged(Theme value)
    {
...
public partial class ThemeOption : ObservableObject
{
    ...
    public ThemeOption(Theme theme, string displayText)
    {
        Theme = theme;
