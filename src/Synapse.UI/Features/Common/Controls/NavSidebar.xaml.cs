        ...
        foreach (var item in MoreMenuFlyout.Items)
        {
            if (item is MenuFlyoutItem menuItem)
            {
                ...
                menuItem.Text = tag switch
                {
                    ...
                    "OpenLogs" => _moreMenuViewModel.MenuLogs,
                    "OpenChangeHistory" => _moreMenuViewModel.MenuChangeHistory,
                    "OpenScripts" => _moreMenuViewModel.MenuScripts,
                    "Support" => _moreMenuViewModel.MenuSupport,
                    "CloseApp" => _moreMenuViewModel.MenuClose,
                    _ => menuItem.Text
                };
        ...
        if (sender is MenuFlyoutItem menuItem && menuItem.Tag is string tag && _moreMenuViewModel != null)
        {
            switch (tag)
            {
                ...
                case "OpenScripts":
                    ...
                    break;
                case "Support":
                    _moreMenuViewModel.SupportCommand.Execute(null);
                    break;
                case "CloseApp":
