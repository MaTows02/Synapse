...
using Synapse.UI.Features.AdvancedTools.Services;
...
using Synapse.UI.Features.Optimize;
...
using Synapse.UI.Features.SoftwareApps.ViewModels;
...
{
    /// <summary>
    /// Registers UI-specific services for the  WinUI 3 application.
    /// </summary>
    ...
    public static IServiceCollection AddUIServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IRegeditLauncher, Synapse.UI.Features.Common.Utilities.RegeditLauncher>();
