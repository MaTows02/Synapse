...
public partial class MoreMenuViewModel : ObservableObject, IDisposable
{
    ...
    private void OnLanguageChanged(object? sender, EventArgs e)
    {
        ...
        OnPropertyChanged(nameof(MenuLogs));
        OnPropertyChanged(nameof(MenuChangeHistory));
        OnPropertyChanged(nameof(MenuScripts));
        OnPropertyChanged(nameof(MenuSupport));
        OnPropertyChanged(nameof(MenuClose));
    }
