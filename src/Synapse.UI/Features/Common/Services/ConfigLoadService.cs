...
using Synapse.Core.Features.Common.Helpers;
...
public class ConfigLoadService : IConfigLoadService
{
        ...
        try
        {
            ...
            if (loadedConfig.Version != "2.0")
            {
                ...
                await _dialogService.ShowInformationAsync(
                    ...
                    ?? $"This configuration file version ({versionText}) is not compatible with this version of Synapse.",
    ...
    public async Task<UnifiedConfigurationFile?> LoadRecommendedConfigurationAsync()
    {
        try
        {
            ...
            var resourceName = "Synapse.UI.Resources.Configs.Synapse_Recommended_Config.synapse";
    ...
    public async Task<UnifiedConfigurationFile?> LoadWindowsDefaultsConfigurationAsync()
    {
        try
        {
            ...
            var resourceName = isWindows11
                ? "Synapse.UI.Resources.Configs.Synapse_Default_Config_Windows11_25H2.synapse"
                : "Synapse.UI.Resources.Configs.Synapse_Default_Config_Windows10_22H2.synapse";
